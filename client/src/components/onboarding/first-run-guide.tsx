...
const GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    tip: 'Start here to find and explore HCPs',
  },
  {
    id: 'audience-builder',
    ...
    tip: 'Create audiences from HCP Explorer selections',
  },
  {
    ...
    tip: 'Test strategies before committing resources',
  },
  {
    id: 'dashboard',
    title: 'Dashboard',
    description: 'Your mission control for metrics and insights.',
    icon: LayoutDashboard,
    iconColor: 'text-emerald-400',
    detail: 'Monitor engagement metrics, track patterns, and stay on top of platform health from one central location.',
    tip: 'Click any metric to drill down',
  },
  {
    id: 'shortcuts',
